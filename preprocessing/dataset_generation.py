...
for i in range(1, 26):
    try:
        ...
        # mail = mailparser.parse_from_file('../../Mailboxes/PhishingCorpus_Jose_Nazario/public_phishing/phishing3/{}.eml'.format(i))
        # mail = mailparser.parse_from_file('../../Mailboxes/Joy_Mailbox/{}.eml'.format(i))
        mail = mailparser.parse_from_file('../../Mailboxes/IndividualTestMails/Phish/phish_{}.eml'.format(i))
